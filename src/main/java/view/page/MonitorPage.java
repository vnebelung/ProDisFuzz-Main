...
//
///**
// * This class is the JavaFX based monitor page, responsible for visualizing the process of setting the monitor
// options used for
...
//
//    /**
//     * Creates the listener for the monitor address and port. Every change will readDirectory a timer so that the
// user has time
