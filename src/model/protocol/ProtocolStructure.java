...
public class ProtocolStructure {
    ...
    private List<ProtocolBlock> protocolBlocks;
    ...
    /**
     * Returns all byte values of the protocol block with the given index.
     *
     * @param index the index of the protocol block
    ...
    public Byte[] getBytes(int index) {
        ...
        return protocolBlocks.get(index).getBytes();
    }
