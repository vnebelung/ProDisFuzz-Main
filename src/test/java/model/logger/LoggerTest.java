...
public class LoggerTest {
    ...
    public void testInfo() throws Exception {
        ...
        Assert.assertEquals(messages[0].getType(), Message.Type.INFO);
    ...
    public void testFine() throws Exception {
        ...
        Message[] messages = logger.getUnreadEntries();
        Assert.assertEquals(messages.length, 1);
        Assert.assertEquals(messages[0].getType(), Message.Type.FINE);
    ...
    public void testError() throws Exception {
        ...
        Message[] messages = logger.getUnreadEntries();
        Assert.assertEquals(messages.length, 1);
        Assert.assertEquals(messages[0].getType(), Message.Type.ERROR);
    ...
    public void testWarning() throws Exception {
        ...
        Message[] messages = logger.getUnreadEntries();
        Assert.assertEquals(messages.length, 1);
        Assert.assertEquals(messages[0].getType(), Message.Type.WARNING);
