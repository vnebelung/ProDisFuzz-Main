...
public class ReleaseInformationTest {
    ...
    public void testGetNumber() throws Exception {
        ReleaseInformation releaseInformation = new ReleaseInformation(12, "test", "date", "requ", new String[]{"1",
                "2"});
    ...
    public void testCompareTo() throws Exception {
        ReleaseInformation releaseInformation1 = new ReleaseInformation(12, "test", "date", "requ", new String[]{"1",
                "2"});
        ReleaseInformation releaseInformation2 = new ReleaseInformation(13, "test", "date", "requ", new String[]{"1",
                "2"});
