...
class Pages {
    ...
    /**
     * Instantiates a new pages list. Each page has a successor and a predecessor page (except for the first and
     * last page), so that it is possible to navigate through pages. The current page pointer is set to the first page.
     */
    public Pages() {
        pages = new ArrayList<>();
        currentIndex = 0;
    ...
    /**
     * Sets the current page pointer to the first page and returns it. If there are no pages the
    ...
    /**
     * Decreases the current page pointer and returns that page. If there are no predecessors of the current page
